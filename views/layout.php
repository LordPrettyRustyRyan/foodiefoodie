...
$sql = "SELECT * FROM Recipes WHERE id = $value";
...
echo ' <div class="caroo">';
    echo ' <div class="carousel-container">';
        echo ' <div class="carousel">';
            echo ' <img src="recipe/'.htmlspecialchars($row['step_1']).'" class="carousel-img active" alt="Image 1">';
            echo ' <img src="recipe/'.htmlspecialchars($row['step_2']).'" class="carousel-img" alt="Image 2">';
            echo ' <img src="recipe/'.htmlspecialchars($row['step_3']).'" class="carousel-img" alt="Image 3">';
        echo ' </div>';

        echo ' <button class="prev-btn">&#10094; Prev</button>';
